...
- Current local best: a validator-passing weighted model soup of the 1,249M, 1,499M, and 1,749M checkpoints at weights 0.50 / 0.15 / 0.35 scored 291.2 XP (raw mean 291.247721) on the full 49,152-world public bank. Its per-seed means are 292.2014, 290.9691, and 290.5726 with zero truncated worlds; archive SHA-256 `652420fb42862f7fc27060c30f5bdf21965c4e99adbefd6ac56f84390364eb18`. It improves the prior 0.40 / 0.20 / 0.40 soup's 290.1 XP but remains local because the official submit route currently requires acceptance of an age-capacity-gated draft legal bundle and a 0.001 USDC x402 charge.
